      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        >
          <span
            ...
            style={{ background: "#F59E0B", boxShadow: "0 0 6px #F59E0B", animation: "livepulse 1.4s ease-in-out infinite" }}
          />
          LIVE
        </span>
      </div>
          ...
          return (
            <div key={opt.label}>
              <div className="mb-1 flex justify-between text-xs" style={{ color: "#5EEAD4" }}>
                <span>{opt.label}</span>
                <span style={{ color: isFlashing ? "#F59E0B" : "#5EEAD4", transition: "color 0.3s" }}>
                  {pct}%
                </span>
              </div>
...
function QRMock() {
  // SVG-based QR-like grid — looks like a real QR code without needing qrcode lib
  const cells: boolean[] = [];
  const seed = 42;
  for (let i = 0; i < 121; i++) {
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center justify-between">
        ...
        <span className="rounded-full px-2 py-0.5 text-xs font-semibold" style={{ background: "rgba(13,148,136,0.15)", color: "#0D9488" }}>
          Published Results
        </span>
      </div>
        ...
        {[
          ...
          <div key={opt.label}>
            <div className="mb-1 flex justify-between text-xs">
              <span style={{ color: opt.winner ? "#0D9488" : "#94A3B8", fontWeight: opt.winner ? 600 : 400 }}>
            ...
            <div className="h-1.5 w-full overflow-hidden rounded-full" style={{ background: "rgba(255,255,255,0.06)" }}>
              <div className="h-full rounded-full" style={{
                width: `${opt.pct}%`,
                background: opt.winner ? "linear-gradient(90deg, #0D9488, #14B8A6)" : "rgba(94,234,212,0.3)",
              }} />
            </div>
          </div>
        ))}
...
function CountdownMock() {
  const [seconds, setSeconds] = useState(5 * 60 + 42); // start at 5m 42s

  useEffect(() => {
    const t = setInterval(() => {
      setSeconds((s) => (s <= 0 ? 5 * 60 + 42 : s - 1));
    }, 1000);
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[280px_1fr]">
        ...
        {SHOWCASE_TABS.map((tab, i) => {
          ...
          return (
            <button
              key={tab.id}
              onClick={() => setActive(i)}
              className="flex shrink-0 items-center gap-3 rounded-xl px-4 py-3 text-left transition-all"
              style={{
      ...
      <div className="min-h-[320px]">
        ...
        <div
          style={{
            animation: "feadein 0.3s ease both",
          }}
        >
          <ActiveComponent />
        </div>
  ...
  return (
    <div className="landing min-h-screen" style={{ background: "#0A0F0F", color: "#F0FDFA" }}>
      <style>{`
        ...
        .landing-heading { font-family: 'Instrument Serif', Georgia, serif; }
      ...
      <nav className="relative z-10 mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        ...
        <div className="flex items-center gap-3">
          <Link to="/auth/login" className="rounded-lg px-4 py-2 text-sm font-medium" style={{ color: "#5EEAD4" }}>
            Sign in
          </Link>
          <Link to="/auth/register" className="ctabtn rounded-lg px-4 py-2 text-sm font-semibold" style={{ background: "#0D9488", color: "#F0FDFA" }}>
            Get started
          </Link>
        </div>
      </nav>
      ...
      <section className="relative z-10 py-24" style={{ borderTop: "1px solid rgba(13,148,136,0.1)" }}>
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-14 text-center">
            ...
            <h2 className="landing-heading text-4xl tracking-tight lg:text-5xl" style={{ color: "#F0FDFA" }}>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div>
              ...
              <AnalyticsMock />
              <p className="mt-3 text-sm" style={{ color: "rgba(94,234,212,0.5)" }}>
                Option breakdowns, daily timelines, anonymous vs identified — all live via WebSocket.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 py-20" style={{ borderTop: "1px solid rgba(13,148,136,0.1)", borderBottom: "1px solid rgba(13,148,136,0.1)" }}>
        <div className="mx-auto max-w-6xl px-6">
          <p className="mb-10 text-center text-sm font-medium uppercase tracking-widest" style={{ color: "rgba(94,234,212,0.4)" }}>
            Sound familiar?
          </p>
      ...
      <section className="relative z-10 py-20">
        <div className="mx-auto max-w-2xl px-6 text-center">
          <div
            ...
            style={{ background: "#111918", border: "1px solid rgba(13,148,136,0.2)", borderLeft: "3px solid #0D9488" }}
          >
            <p className="text-lg leading-relaxed" style={{ color: "#F0FDFA" }}>
              "Finally a polling tool where I can see results updating as my students respond —
              without refreshing the page once. The live countdown meant nobody submitted late either."
            </p>
            <div className="mt-5 flex items-center justify-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold" style={{ background: "rgba(13,148,136,0.2)", color: "#0D9488" }}>
                A
              </div>
              <div className="text-left">
                <p className="text-sm font-medium" style={{ color: "#F0FDFA" }}>Secondary school teacher</p>
                <p className="text-xs" style={{ color: "#5EEAD4" }}>34 responses collected live · classroom vote</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {STEPS.map((step, i) => (
              <div key={step.num} className="flex flex-col">
                ...
                {step.visual}
                {i < STEPS.length - 1 && (
                  <div className="mt-4 hidden h-px lg:block" style={{ background: "rgba(13,148,136,0.1)" }} />
                )}
              </div>
            ))}
          </div>
      ...
      <section className="relative z-10 py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div
            ...
            style={{ background: "linear-gradient(135deg, rgba(13,148,136,0.18) 0%, rgba(13,148,136,0.04) 100%)", border: "1px solid rgba(13,148,136,0.28)" }}
          >
            ...
            <div className="relative">
              <h2 className="landing-heading mb-4 text-4xl tracking-tight lg:text-5xl" style={{ color: "#F0FDFA" }}>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
            ...
            <div className="flex items-center gap-6 text-xs" style={{ color: "rgba(94,234,212,0.5)" }}>
              <button onClick={() => document.querySelector(".landing section")?.scrollIntoView({ behavior: "smooth" })} className="transition-colors hover:text-teal-300">Features</button>
