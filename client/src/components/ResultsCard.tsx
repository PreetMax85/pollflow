    ...
    return (
      ...
      >
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {[...question.options]
                  ...
                  .map((option) => {
                    const isWinner = option.optionId === topOption?.optionId
        ...
        {questions.length > 4 && (
          ...
          >
            + {questions.length - 4} more question{questions.length - 4 !== 1 ? "s" : ""} — view full results at pollflow.tech
          </p>
        )}
